...
(function (window, factory) {
    if (typeof define == 'function' && define.amd) {
        ...
        module.exports = factory(window, require('galleria'), require('jquery'));
    }
    else {
        factory(window, window.Galleria, window.jQuery);
    }
    ...
    */
    ...
    Galleria.prototype.load = function () {
        ...
        var self = this, args = Galleria.utils.array(arguments), flickr = this._options.flickr.split(':'), f, opts = $.extend({}, self._options.flickrOptions), loader = typeof opts.loader !== 'undefined' ?
            opts.loader : $('<div>').css({
            width: 48,
            height: 48,
            opacity: 0.7,
