...
(function (window, factory) {
    ...
    _loadedThemes = [], _themeLoad = function (theme) {
        ...
        var lightbox = this._lightbox = {
            ...
            init: function () {
                ...
                var elems = 'overlay box content shadow title info close prevholder prev nextholder next counter image', el = {}, op = self._options, css = '', abs = 'position:absolute;', prefix = 'lightbox-', cssMap = {
                    ...
                    return elem.hover(function () { $(this).css('color', '#bbb'); }, function () { $(this).css('color', '#444'); });
                }, appends = {};
    ...
    Galleria.prototype = {
        ...
        */
        ...
        _createThumbnails: function (push) {
            this.get('total').innerHTML = this.getDataLength();
            var src, thumb, data, $container, self = this, o = this._options, i = push ? this._data.length - push.length : 0, chunk = i, thumbchunk = [], loadindex = 0, gif = IE < 8 ? 'http://upload.wikimedia.org/wikipedia/commons/c/c0/Blank.gif' :
            ...
            getStyle = function (prop) {
                ...
                thumb.scale({
                    ...
                    complete: function (thumb) {
                        ...
                        Utils.toggleQuality(thumb.image, o.thumbQuality === true ||
    ...
    $(document).mousemove(function(e) {
        ...
        */
        addPan: function (img) {
            ...
            var self = this, x = img.width() / 2, y = img.height() / 2, destX = parseInt(img.css('left'), 10), destY = parseInt(img.css('top'), 10), curX = destX || 0, curY = destY || 0, distX = 0, distY = 0, active = false, ts = Utils.timestamp(), cache = 0, move = 0, 
            // positions the image
    ...
    Galleria.Picture.prototype = {
        ...
        */
        load: function (src, size, callback) {
            ...
            var reload = false, resort = false, 
            // some jquery cache
            $container = $(this.container), $image = $(this.image), onerror = function () {
                if (!reload) {
                    reload = true;
        ...
        Finger.prototype = {
            ...
            ontouchend: function (e) {
                ...
                var isValidSlide = +new Date() - this.start.time < 250 &&
                    ...
                    M.abs(this.deltaX) > this.width / 2, isPastBounds = !this.index && this.deltaX > 0 ||
